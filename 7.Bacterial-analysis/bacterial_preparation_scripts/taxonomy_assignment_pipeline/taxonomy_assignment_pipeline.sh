...
IDS=/ahg/regevdata/projects/ST_SpatialTranscriptomics/ids/10015_barcodes.txt

# Keep all temporary files (usually no): yes/no
KEEP_ALL_FILES=no

# Genome reference mouse BWA index
MOUSEREF=/ahg/regevdata/projects/splotch_spatial_transcriptomics/britta_bac/genomes/mouse/bwa/GCF_000001635.27_GRCm39_genomic.fna
